    ...
    try {
      const { error } = await supabase
        ...
        .update({
          ...
          modification_requests: [...(application.modification_requests || []), modificationRequest],
          status_history: [...(application.status_history || []), {
            status: "changes_requested",
            timestamp: new Date().toISOString(),
            user_id: user.id,
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto bg-covenLightPurple rounded-lg p-6">
        <h1 className="text-3xl font-bold text-white mb-6">Review Your Application</h1>
        ...
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-white mb-4">Approved Profile Details</h2>
